...
export const SuperAdminSignup = () => {
  ...
  async function handleForm(e) {
    e.preventDefault();
    if (validate()) {
      const resoponce = await publicAxios.post("/auth/signup/superadmin", form);
  ...
  return (
    <div className="  my-0  relative">
      <div className="flex justify-start w-[98%] mx-auto mt-3">
        <ReverseButton route={"/"} routeName={"SuperAdmin"} css={"text-left"} />
      </div>
      <div className="mt-10 flex flex-col items-center ">
        ...
        >
          ...
          <p className="flex justify-center mt-4 text-blue-400">
