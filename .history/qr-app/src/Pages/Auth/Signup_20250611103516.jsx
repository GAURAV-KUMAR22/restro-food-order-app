      ...
      <div className="mt-10 flex flex-col items-center ">
        ...
        >
          ...
          <div className="flex flex-col">
            <label
              htmlFor="file-upload"
              className="m-2 border border-gray-400 pl-2 h-12 rounded-md flex items-center justify-center cursor-pointer hover:bg-gray-100 active:bg-gray-200"
            >
              Upload File
            </label>
