  ...
  return (
    <div className=" h-full mt-10 px-10">
      ...
      <div className="flex flex-col sm:flex-row justify-center overflow-x-scroll my-10 gap-12">
        <div className=" relative min-w-[250px] h-[600px] border p-2 bg-blue-100 shadow-2xl hover:scale-105 m-4">
        ...
        <div className=" relative w-[300px] h-[600px] border p-2 bg-blue-100 shadow-2xl hover:scale-105 m-4">
          <h1 className="text-center text-3xl font-bold  border-[50%] border-b-2 mb-15">
            Basic
          </h1>
