...
export const DashBoardPage = () => {
  ...
  const [handleAdminSetting, setHandleAdminSetting] = useState(false);
    ...
    <div className="min-w-[375px] h-auto relative">
        ...
        {showMenu && (
          <div className="mt-2 bg-white shadow-lg rounded-md py-2 w-20 border">
            <button
              ...
              onClick={() => setHandleAdminSetting(true)}
            >
              Settings
            </button>
            <button
      ...
      {handleAdminSetting && (
        <div className="fixed inset-0 z-50 flex justify-center items-center">
          ...
          {/* Modal content */}
          <div className="relative w-[500px] bg-white rounded-lg p-6 z-50 shadow-xl">
            <h1 className="text-center text-xl font-semibold mb-4">Settings</h1>
            <ul className="space-y-2">
              <li className="border-b py-2">Complaint</li>
              <li className="border-b py-2">Mode</li>
            </ul>
          </div>
        </div>
      )}
