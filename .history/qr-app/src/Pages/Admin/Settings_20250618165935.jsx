...
export const Settings = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap gap-5 mx-20 w-[90%]  my-10">
        <div className="w-[240px] h-10 shadow-2xl bg-gray-200 px-2 py-2 hover:bg-amber-300">
          <button onClick={() => setProfileModel(true)}>
            <h1>Profile</h1>
          </button>
        </div>
        <div className="w-[240px] h shadow-2xl bg-gray-200 px-2 py-2 hover:bg-amber-300">
