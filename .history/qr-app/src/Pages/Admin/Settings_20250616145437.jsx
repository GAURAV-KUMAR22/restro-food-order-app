    ...
    <div>
      <div>
        ...
        <div className="flex justify-center items-center ">
          <div className="fixed inset-0 z-10 bg-red-400 justify-center items-center"></div>
          <div className="absolute w-[300px] h-auto bg-white">
            <form>
              <legend>Raise complaints</legend>
            </form>
          </div>
        </div>
      </div>
