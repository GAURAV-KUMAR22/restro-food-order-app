...
export const DashBoardPage = () => {
  ...
  const [coverImageModel, setCoverImageModel] = useState(true);
    ...
    <div className="min-w-[375px] h-auto relative">
      ...
      {coverImageModel && (
        <div className="fixed inset-0 z-50 flex justify-center items-center">
          ...
          <div className="absolute w-[600px] h-[300px] bg-white px-4">
            <h1 className="text-center">Update Cover Image</h1>
            ...
            <button className="mt-10 border p-2 w-full bg-amber-400">
              Upload Image
            </button>
          </div>
        </div>
