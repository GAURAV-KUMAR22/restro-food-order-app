...
export const Package = () => {
  ...
  return (
    <div className="h-full mt-10 px-10">
      ...
      <div
        className="flex flex-col sm:flex-row justify-center overflow-x-scroll my-10 gap-12 scroll-smooth snap-center m-2"
      ...
      >
        {packageItems.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className={`min-w-[280px] w-[300px] h-[500px] bg-blue-100 shadow-xl p-6 rounded-xl transition-transform duration-500 hover:scale-105 flex flex-col justify-between items-center`}
              style={{
