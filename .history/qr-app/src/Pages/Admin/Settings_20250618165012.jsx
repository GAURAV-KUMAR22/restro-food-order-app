...
export const Settings = () => {
  ...
  const [profileModel, setProfileModel] = useState(true);
      ...
      <div>
        ...
        {profileModel && (
          <div className="fixed inset-0 z-50 flex justify-center items-center">
            <div className="relative absolute inset-0 drop-shadow-2xl bg-opacity-30 backdrop-blur-sm"></div>
            <img
              src={cross}
              alt="cross"
              className="w-[40px] h-[40px] absolute rotate-0 top-2 text-red-500"
            />
            <div className="absolute w-[600px] h-[500px] bg-white px-4 py-6 rounded-lg shadow-lg mx-auto">
