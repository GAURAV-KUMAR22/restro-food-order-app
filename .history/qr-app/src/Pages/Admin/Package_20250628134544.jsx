      ...
      >
        {packageItems.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className="min-w-[280px] w-[300px] h-[500px] bg-blue-100 shadow-xl p-6 rounded-xl transition-transform duration-500 hover:scale-105 flex flex-col justify-between items-center m-6"
              style={{
