    ...
    <div className="flex flex-col box-border">
      ...
      <div className="flex  m-4 flex-col">
        <div className="flex justify-start items-center">
          ...
          <div className="flex flex-row items-center w-[75%] mx-auto sm:w-[26%] gap-4">
            <div className="">
              <label htmlFor="file-upload" className="cursor-pointer">
                <div className="bg-gray-600 w-[40px] h-[50px] object-contain rounded-full items-center justify-center flex">
                  {image ? (
                    <img
                      src={image}
                      alt="file upload"
