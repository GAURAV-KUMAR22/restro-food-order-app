  ...
  return (
    <div className="p-4 md:p-6 bg-white rounded-lg shadow-md min-h-screen relative">
      <div className="flex justify-between items-center mb-4">
        <h2 className="font-bold text-gray-400 italic text-xl bg-blue-100">
          SUPERADMIN PANEL
        </h2>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 top-full mt-1 bg-white shadow-md rounded-md w-48 z-50">
                <ul className="text-sm">
                  ...
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
                    <Link to={`${location.pathname}/setting`}>Settings</Link>
                  </li>
                  <li
      ...
      <div className="flex gap-4 flex-wrap mb-4 bg-blue-300 text-black">
