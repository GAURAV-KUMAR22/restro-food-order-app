...
export const NewPackage = () => {
  return (
    <div>
      <form className="w-full  bg-gray-200 flex flex-col justify-center items-center gap-10  sm:flex-row sm:w-[40%] sm:mx-auto shadow-2xl">
        <div className="w-full flex flex-col m-4 sm:m-4">
