...
export const PackagesSuperAdmin = () => {
  return (
    <div className="px-2">
      <div>
        <header className="flex justify-end items-center bg-gray-300 p-2">
          <Link className="text-md rounded-sm font-semibold bg-blue-400 p-1 px-2">
            Add Package
          </Link>
        </header>
        <div className=" h-full mt-10 px-10">
          ...
          >
            <div className=" relative min-w-[250px] h-[600px]  p-2 bg-blue-100 shadow-2xl hover:scale-105 transition duration-300 ease-in-out m-4 ">
