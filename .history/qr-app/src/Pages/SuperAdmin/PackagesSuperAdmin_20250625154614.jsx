          ...
          >
            {packageItem &&
              ...
              packageItem.map((item, index) => (
                <div
                  key={index}
                  className="flex flex-col hover:grow justify-between w-[300px] h-[600px] bg-blue-100 shadow-xl p-4 rounded-xl hover:scale-105 transition-transform duration-300 m-4"
                >
                  <div>
