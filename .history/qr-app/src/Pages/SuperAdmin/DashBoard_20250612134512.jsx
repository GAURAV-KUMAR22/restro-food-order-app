      ...
      <div className="flex gap-6">
        ...
        <div className="w-6/7">
          ...
          <div className="grid grid-cols-4 gap-4">
            <div className="h-20 bg-gray-200 hover:bg-white text-center text-white font-extrabold ">
              All Admins
            </div>
            <div className="h-20 bg-gray-500 hover:bg-white text-center text-white font-extrabold ">
