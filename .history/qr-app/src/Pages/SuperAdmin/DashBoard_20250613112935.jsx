...
import { BellIcon, Edit, Home, Trash2, User, User2Icon } from "lucide-react";
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md h-[100vh]">
      ...
      <div className="w-full flex flex-row justify-between items-center mb-6">
        ...
        <div className="space-x-2 h-10 inline ">
          <input
            type="text"
          ...
          <div>
            <h1>UserName</h1><span></span>
          </div>
          <button
            className="p-2 bg-red-400 font-semibold rounded-lg"
