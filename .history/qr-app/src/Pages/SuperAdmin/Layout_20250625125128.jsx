...
export const SuperAdminLayout = () => {
  ...
  return (
    <div className="p-4 md:p-6 bg-white rounded-lg shadow-md min-h-screen relative">
      ...
      {/* Menu Bar */}
      <div className="flex flex-wrap bg-gray-200 min-h-[3rem] my-2 justify-between  items-center gap-2 rounded-md">
        <div className="flex overflow-x-scroll sm:flex-row gap-4">
        ...
        <div className="bg-[#2C333B] text-white w-fit px-2 h-10 flex justify-end items-center rounded-lg my-2 text-sm">
