...
export const ProfileAdmin = () => {
  ...
  return (
    <div className="my-6 mx-2 bg-gray-100">
      <header className="flex flex-col gap-4 sm:flex-row justify-between items-center m-2">
      ...
      <div className="mt-6">
        <div className="flex flex-col gap-4 sm:flex-row w-full justify-between">
          <div className="w-full">
            ...
            <p className="py-2 rounded-xl pl-4 bg-gray-100 text-gray-700">
              {adminProfile?.name}
            </p>
          </div>
          <div className="w-full">
        ...
        <div className="mt-4 text-gray-500">
          Created User
          <p className="w-[48.5%] py-2 rounded-xl pl-4 bg-gray-100 text-gray-700">
