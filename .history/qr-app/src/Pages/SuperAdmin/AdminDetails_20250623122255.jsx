  ...
  return (
    <div className="">
      ...
      <div className="flex justify-between">
        <div className="flex flex-wrap items-center justify-between bg-gray-200 w-full h-auto space-x-6 my-2 ">
          ...
          <div className="flex gap-2 justify-center items-center bg-gray-200">
            <BellIcon size={20} />
            <User2 size={20} />
          </div>
        </div>
