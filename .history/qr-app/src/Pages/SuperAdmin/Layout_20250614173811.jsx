...
export const SuperAdminLayout = () => {
  ...
  async function handleSubmit(e) {
    ...
    Form.append("name", form.name ? form.name : superadmin[0].name);
    Form.append("password", form.password ? form.password :null;
    Form.append("phone", form.phone ? form.phone : superadmin[0].phone);
    Form.append("image", updatedImage?updatedImage:null);
    const respnose = await PrivateAxios.patch("/auth/updateSuperadmin", Form);
          ...
          <div className="fixed inset-0 z-10">
            ...
            <div className="absolute left-1/2 top-1/2 z-20 w-[500px] h-auto -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-xl p-6">
              ...
              <form onSubmit={handleSubmit}>
                <div className="flex flex-row justify-center mx-auto items-center w-[150px] h-[150px] rounded-full bg-red-400">
                  {superAdminManage.avatar ? (
                    <img src={superadmin.avatar} alt="image" />
                  ) : (
                    <User2 size={80} />
                  )}
                </div>
                <div className="flex flex-col gap-4">
                  ...
                  <input
                    ...
                    placeholder="Name"
                    value={superadmin ? superadmin[0].name : "Enter Name"}
                  ...
                  <input
                    ...
                    id="phone"
                    className="border p-2 rounded"
                    value={superadmin?.phone && superadmin[0].phone}
