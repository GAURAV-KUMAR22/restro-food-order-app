      ...
      <div className="h-full mt-4 px-4">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {packageItem.map((item, index) => {
            let rotationClass = "";
            if (index % 3 === 0) rotationClass = "-rotate-6 translate-x-2 ";
            else if (index % 3 === 2) rotationClass = "rotate-6 translate-y-2";

            return (
              <div
                key={index}
                className={`min-w-[280px] w-[300px] h-[500px] rotate-z-12 bg-blue-100 shadow-xl p-6 rounded-xl transition-transform duration-500 hover:scale-105 flex flex-col justify-between items-center ${rotationClass}`}
              >
