    ...
    <div className="p-6 bg-white rounded-lg shadow-md min-h-screen relative">
      ...
      {openComplaintModel && (
        <div className="fixed inset-0 z-50 flex justify-center items-center">
          ...
          <div className="w-[700px] h-[500px] bg-white shadow-md">
            <h1 className="text-2xl text-gray-500 font-semibold text-center my-4">
              Complaints
            </h1>
            <div className="mx-4 my-2 gap-3">
              <div className="w-full shadow-xl space-y-3">
                <p className="flex">
                  ComplaintId# : <span>565546546565</span>
                </p>
                <p>
                  AdminId : <span>264654454</span>
                </p>
                <p>
                  AdminName : <span>Gaurav kumar</span>
                </p>
                <p>
                  Subject : <span>UI Issue</span>
                </p>
              </div>
