...
export const SuperAdminLayout = () => {
  ...
  return (
    <div
      className="p-4 md:p-6 bg-white rounded-lg shadow-md min-h-screen relative"
      onClick={() => setSuperAdminMange(false)}
    >
      {/* Header */}
                ...
                <ul className="flex flex-col space-y-1">
                  ...
                  <li>
                    ...
                    >
                      Complaints
                      {complaints.length > 0 && (
                        <span className="absolute top-2 right-3 h-5 w-5 bg-red-500 text-white text-xs flex items-center justify-center rounded-full">
                          {complaints.length}
                        </span>
                      )}
                    </button>
