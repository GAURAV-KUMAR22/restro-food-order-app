      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-gray-800 p-4 rounded-lg shadow">
          ...
          <p className="text-sm font-bold">
            Unique session: {visitorData.totalUniqueVisitors}
          </p>
          <p className="text-sm text-green-400">+9.5% compared to last week</p>
          <ul className="mt-2 space-y-1 text-sm text-gray-300">
            <li>
              📱 Mobile: <span>{visitorData?.devices?.mobile ?? 0}</span>
            </li>
            <li>
              💻 Desktop: <span>{visitorData?.devices?.desktop ?? 0}</span>
            </li>
            <li>
              📟 Tablet: <span>{visitorData?.devices?.tablet ?? 0}</span>
            </li>
          </ul>
        </div>
      </div>
