            ...
            {superAdminManage && (
              <div className="absolute top-10 right-0 w-40 bg-white shadow-lg rounded-md z-10 py-2">
                <ul className="flex flex-col space-y-1">
                  ...
                  <li>
                    <button
                      className="relative w-full text-left px-2 py-2 hover:bg-gray-100"
                      onClick={() => setOpenComplaintModel((prev) => !prev)}
                    >
                      Complaints{" "}
                      <span className="absolute right-2 w-3 h-3  rounded-full text-red-500 border border-red-500 flex justify-center items-center">
                        {complaints.length}
                      </span>
                    </button>
                  </li>
