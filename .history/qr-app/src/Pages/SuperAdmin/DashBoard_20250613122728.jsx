...
export const DashBoard = () => {
  ...
  const sideBar = [
    {
      name: "Dashboard",
      pathName: "/superAdmin",
      icon: LayoutDashboard, // ✅ not <LayoutDashboard />
    },
    {
      name: "All Admins",
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md h-[100vh]">
      ...
      <div className="w-full flex flex-row justify-between items-center mb-6 px-2 font-semibold">
        <h2 className="text-xl font-semibold text-gray-600">Superadmin</h2>
        <div className="flex space-x-4 h-10 items-center">
          ...
          <div className="flex items-center space-x-1">
            <User2Icon size={25} color="black" />
          </div>
          <div className="flex items-center space-x-1">
            <h1 className="text-sm font-medium">UserName</h1>
            <SquareArrowDown color="black" size={25} />
          </div>
          {/* <button
      ...
      <div className="w-full">
        <div className="my-2">
          <h1 className="text-gray-500 font-bold text-2xl">
            Welcome in Superadmin DashBoard
          </h1>
        </div>
        <div className="bg-[#2C333B] text-white w-fit px-2 h-10 flex justify-center items-center rounded-lg my-2 ">
        ...
        <div className="flex bg-gray-200 h-10 my-2 items-center space-x-6">
          {sideBar.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className={`flex items-center space-x-2 px-2 py-2 text-white ${
        ...
        <div className="w-[100%] flex  gap-4">
          <div className="w-[50%] h-[250px] bg-[#2C333B] p-2">
            <div className="flex flex-row">
              <h2 className="flex text-sm text-gray-400 font-bold   ">
                Totel Sale{" "}
            ...
            <div className="mt-4">
              <h1 className="text-2xl text-white font-bold ">$25,425.05 </h1>
              <p className="flex  items-center">
                <CircleChevronUp size={15} color="gray" />
                <span className="text-sm text-gray-400 px-2">
                  10% compare to last week
                </span>
              </p>
            </div>
          </div>
          <div className="w-[25%] h-[250px] bg-[#2C333B]"></div>
          <div className="w-[25%] h-[250px] bg-[#2C333B]"></div>
        </div>
      </div>
    </div>
