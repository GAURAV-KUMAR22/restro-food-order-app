...
export const SuperAdminLayout = () => {
  ...
  <div className="fixed inset-0 z-50 flex justify-center items-center bg-black bg-opacity-30">
    <div className="w-[700px] h-[500px] bg-white shadow-2xl rounded-lg overflow-hidden">
      <h1 className="text-2xl text-gray-700 font-semibold text-center py-4 border-b">
        Complaints
      </h1>
      <div className="px-6 py-4 space-y-4 overflow-y-auto h-[420px]">
        {[1, 2, 3, 4].map((_, index) => (
          <div key={index} className="w-full p-4 bg-gray-100 rounded shadow">
            <p className="font-medium">
              Complaint ID#: <span className="font-normal">565546546565</span>
            </p>
            <p className="font-medium">
              Admin ID: <span className="font-normal">264654454</span>
            </p>
            <p className="font-medium">
              Admin Name: <span className="font-normal">Gaurav Kumar</span>
            </p>
            <p className="font-medium">
              Subject: <span className="font-normal">UI Issue</span>
            </p>
          </div>
        ))}
      </div>
