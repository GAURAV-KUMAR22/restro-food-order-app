  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md h-[100vh]">
      ...
      <div className="w-full">
        ...
        <div className="bg-black text-white w-fit px-2 h-10 flex justify-center items-center rounded-lg my-2 ">
        ...
        <div className="w-[100%] flex  gap-4">
          <div className="w-[50%] h-[250px] bg-black-200">
            <div>
              <h2 className="text-sm text-gray-400 font-bold pl-4 py-2">
                Totel Sale
              </h2>
            </div>
          </div>
          <div className="w-[25%] h-[250px] bg-black"></div>
          <div className="w-[25%] h-[250px] bg-black"></div>
        </div>
      </div>
    </div>
