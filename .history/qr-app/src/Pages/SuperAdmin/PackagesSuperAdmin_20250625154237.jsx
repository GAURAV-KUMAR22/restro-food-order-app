          ...
          >
            {packageItem &&
              ...
              packageItem.map((item, index) => (
                <div
                  key={index}
                  className=" relative min-w-[250px] h-[600px] hover:grow  p-2 bg-blue-100 shadow-2xl hover:scale-105 transition duration-300 ease-in-out m-4 "
                >
                  ...
                  <p className="flex justify-center items-center gap-1 font-semibold text-gray-600">
                    Duration:
                  ...
                  <ul className="flex flex-col items-start text-sm font-bold gap-5 mt-10 text-wrap">
                    {item.features.map((fet, feIndex) => (
                      <li
                        key={feIndex}
                        className="flex items-start gap-2 text-wrap"
                      >
                        <span className="text-green-600 mt-0.5 rounded-full">
                          ✅
                        </span>
                        <span className="text-wrap">{fet}</span>
                      </li>
                    ))}
                  </ul>
