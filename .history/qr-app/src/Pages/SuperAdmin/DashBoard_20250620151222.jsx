    ...
    <div className="p-6 space-y-6 bg-gray-900 text-white min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-gray-800 p-4 rounded-lg shadow">
          ...
          <p className="text-3xl font-bold">{visitorInfo.totalVisits}</p>
          ...
          <ul className="mt-2 space-y-1 text-sm text-gray-300">
            <li>
              📱 Mobile: <span>{visitorInfo?.devices?.mobile ?? 0}</span>
            </li>
            <li>
              💻 Desktop: <span>{visitorInfo?.devices?.desktop ?? 0}</span>
            </li>
            <li>
              📟 Tablet: <span>{visitorInfo?.devices?.tablet ?? 0}</span>
            </li>
          </ul>
        </div>
      </div>
