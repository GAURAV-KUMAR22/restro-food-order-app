    ...
    <div className="p-6 bg-white rounded-lg shadow-md">
      ...
      <table className="w-full text-left border-collapse">
        ...
        <tbody className="text-sm">
          {pendingAdminss.map((pendingAdmins, index) => (
            <tr key={index} className="border-t">
              <td className="py-3 px-4 flex items-center space-x-2">
                <img
                  src={pendingAdmins.avatar}
                  alt="avatar"
                  className="w-8 h-8 rounded-full"
                />
                <div>
                  <div className="font-medium">{pendingAdmins.name}</div>
                  <div className="text-gray-500 text-xs">
                    {pendingAdmins.name.split(" ")[0]}
                  </div>
                </div>
              </td>
              <td className="py-3 px-4">
                <div>{pendingAdmins.email}</div>
                <div className="text-gray-500 text-xs">
                  {pendingAdmins.phone}
                </div>
              </td>
              ...
              <td className="py-3 px-4">{pendingAdmins.address}</td>
