...
export const AdminDetails = () => {
  ...
  const sideBar = [
    ...
    { name: "Profile", pathName: "profile", icon: User2 },
  ];
  const backendUrl =
  ...
  return (
    <div className="">
      {/* Sidebar */}
      <div className="flex justify-between border border-gray-400 mb-2">
        ...
        <div className="flex gap-2 justify-center items-center mr-5 ">
          <BellIcon size={30} />
          <h1 className="flex flex-row font-semibold px-2">
            {adminProfile?.name}
          </h1>
          <Link to={`/superAdmin/admin-list/${id}/profile`}>
            <img
