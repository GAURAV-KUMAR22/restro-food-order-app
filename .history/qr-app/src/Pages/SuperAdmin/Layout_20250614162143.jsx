      ...
      <div className="flex bg-gray-200 h-10 my-2 items-center space-x-6">
        {superadminProfile && (
          <div className="fixed inset-0 z-10">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-30 text-white backdrop-blur-sm z-10"></div>

            {/* 🔹 Modal Box */}
            <div className="absolute left-1/2 top-1/2 z-20 w-[500px] h-[400px] -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-xl p-6">
              <CrossIcon size={30} className="absolute right-0 top-3" />
              <form>
