...
export const SuperAdminLayout = () => {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    console.log(form, updatedImage && updatedImage);
  }
            ...
            <div className="absolute left-1/2 top-1/2 z-20 w-[500px] h-auto -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-xl p-6">
              ...
              <form onSubmit={handleSubmit}>
                <div className="flex flex-row justify-center mx-auto items-center w-[150px] h-[150px] rounded-full bg-red-400">
                  if({superadmin[0].avatar})
                  {<img src={superadmin.avatar} alt="image" srcset="" />}
                </div>
                <div className="flex flex-col gap-4">
                  ...
                  <input
                    ...
                    value={superadmin ? superadmin[0].password : "Password"}
                    onChange={handleChange}
                  />
