          ...
          <tbody className="text-sm">
            {pendingAdmins.map((item, index) => (
              <tr key={index} className="border-t hover:bg-gray-50">
                ...
                <td className={`py-3 px-4 font-semibold ${item.isApproved ? "text-green-600" : "text-red-500"}`}>
      ...
      <div className="block md:hidden">
        {pendingAdmins.map((item, index) => (
          <div key={index} className="border rounded-lg mb-4 p-4 shadow-sm">
            ...
            <div className={`text-sm font-semibold mb-2 ${item.isApproved ? "text-green-600" : "text-red-500"}`}>
              {item.isApproved ? "ACTIVE" : "PENDING"}
            </div>
