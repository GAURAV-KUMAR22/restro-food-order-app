...
import { PackagesSuperAdmin } from "./Pages/SuperAdmin/PackagesSuperAdmin";
import { NewPackage } from "./Pages/SuperAdmin/NewPackage";
import { CheckoutPageSuccess } from "./Pages/Admin/CheckoutPageSuccess";
import { CheckoutPageFailed } from "./Pages/Admin/CheckoutPageFailed";
import IsSubscriber from "./Services/isSubscriber";
import DashboardLayout from "./Pages/Layout/DashboardLayout";
import { CategoryItems } from "./Pages/Clients/CategoryItems";
        ...
        <Routes className="min-w-[375px] h-auto">
          ...
          >
            ...
            <Route path="setting" element={<SettingSuperAdmin />}>
              <Route path="packages" element={<PackagesSuperAdmin />} />
              <Route path="packages/new-package" element={<NewPackage />} />
            </Route>
          ...
          <Route path="/shop/:shopId">
            ...
            {/* <Route path=":cat" element={<CategoryItems />} /> */}
          ...
          >
            {/* Dashboard homepage as index route */}
            ...
            <Route path="today-orders" element={<TodayOrderStat />} />
            <Route path="settings" element={<Settings />} />
          </Route>

          <Route path="/admin/package" element={<Package />} />
          <Route path="/payment-success" element={<CheckoutPageSuccess />} />
          <Route
            path="/payment-receipt-failed"
            element={<CheckoutPageFailed />}
          />
