...
// admin panel
route.get("/adminProfile", ProtectedRoute, isSuperAdmin, getAdminProfile);
route.post("/signup", upload.single("image"), postNewAdmin);
route.get("/pending-admin", ProtectedRoute, isSuperAdmin, getPendingAdmin);
route.get("/suspended-admin", ProtectedRoute, isSuperAdmin, getSuspendedAdmin);
...
route.get("/CoverImage", upload.single("image"), getCoverImage);

// Visitor info

route.post("/visitor-info", postVisitorinfo);
route.get("/visitor-info", ProtectedRoute, isSuperAdmin, getVisitorInfo);
