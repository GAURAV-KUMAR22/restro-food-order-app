...
export const postCheckoutPayment = async (req, res) => {
  const { packageTitle, price } = req.body;
  const session = await stripe.checkout.sessions.create({
    ...
    mode: "payment",
    success_url: "http://localhost:5173/admin/payment-receipt-success",
    cancel_url: "http://localhost:5173/admin/payment-receipt-failed",
  });
