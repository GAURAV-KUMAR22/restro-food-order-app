  ...
  try {
    ...
    const options = {
      ...
      handler: function (response) {
        ...
        // Manual redirection with payment info in query params
        window.location.href = `/payment-success?payment_id=${
          response.razorpay_payment_id
        }&order_id=${response.razorpay_order_id}&signature=${
          response.razorpay_signature
        }&packageId=${
          pkg._id
        }&startDate=${startDate.toISOString()}&endDate=${endDate.toISOString()}&userId=${userId}`;
      },
    };
